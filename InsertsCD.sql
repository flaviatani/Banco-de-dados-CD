...
INSERT INTO musicaAutor(idMusica, idAutor)
VALUES (1, 1),
	   (1, 4),
	   (1, 5),
	   (2, 1),
...
SELECT * FROM musicaAutor; 
GO

INSERT INTO gravadora
VALUES (1, 'EMI', 'Rod. Dutra, KM - 29.8', 55659856, 89357894, 'emi@emi-music.com.br'),
	   ...
	   (5, 'EPIC', 'Av. Alda, Nº 89', 58793321, 89654789,'epic@music.com.br');
GO

INSERT INTO cd
VALUES (1, 1, 'Mais do Mesmo', -5.00, '1985-03-02', 1),
	   ...
	   (6, 2, 'Barry Manilow Greastest Hits', 25.00, '1985-18-12', 6),
	   (7, 5, 'Listen Without Prejudice', 28.00, '1975-11-06', 7);
GO

/*Comando para alterar DROPAR(Excluir) uma tabela*/
DROP TABLE itemCd;
GO

/*Comando para alterar CONSTRAINT em campos dentro de uma tabela*/
ALTER TABLE faixa
DROP CONSTRAINT PK__faixa__6B603B31E01365D3;
GO
...
/*Comando para excluir todos os dados de uma tabela*/
TRUNCATE TABLE faixa;
GO
...
ALTER TABLE faixa_imovel ALTER COLUMN vl_minimo DECIMAL (9, 2) NOT NULL;  
GO  

ALTER TABLE imovell ADD id_oferta INT NULL;  
GO 

ALTER TABLE imovell ADD CONSTRAINT id_oferta FOREIGN KEY (id_oferta)
